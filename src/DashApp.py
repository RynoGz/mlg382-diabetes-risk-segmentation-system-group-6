...
# 1. Path Setup
# This logic ensures it finds the artifacts folder whether running locally or on the server
...
server = app.server # This is the variable Gunicorn/Hugging Face looks for

# 3. Load Group Artifacts
# We use mmap_mode='r' to keep memory usage low
...
# 5. Layout (Defined at top level so Gunicorn can see it)
app.layout = html.Div([
    html.Div([
